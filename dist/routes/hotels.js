...
router.post("/:hotelId/bookings/payment-intent", auth_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalCost = ((_a = hotel === null || hotel === void 0 ? void 0 : hotel.pricePerNight) !== null && _a !== void 0 ? _a : 0) * numberOfNights;
...
const constructSearchQuery = (queryParams) => {
    ...
    if (Array.isArray(queryParams.stars)) {
        constructedQuery.starRating = {
            $in: queryParams.stars.map((star) => parseInt(star)),
        };
    }
    else if (queryParams.stars) {
        // If queryParams.stars is not an array, but exists, convert it to an array
        constructedQuery.starRating = {
            $in: [parseInt(queryParams.stars)],
        };
    }
